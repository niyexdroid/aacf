...
const testimonials = [
  {
    quote: "The work that AAC Foundation does is truly transformative. I've seen firsthand how their programs change lives and build stronger communities.",
    author: "Sarah Johnson",
    role: "Community Partner",
    image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=3387&auto=format&fit=crop"
  },
  {
    quote: "Being a volunteer with AAC Foundation has been one of the most rewarding experiences of my life. The impact we make is real and lasting.",
    author: "Michael Chen",
    role: "Volunteer",
    image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=3387&auto=format&fit=crop"
  },
  {
    quote: "The dedication and passion of the AAC Foundation team is incredible. They truly care about making a difference in people's lives.",
  ...
  return (
    <section className="bg-white py-24">
      <div className="container mx-auto px-4">
        <h2 className="mb-16 text-center text-3xl font-bold">What People Say</h2>
