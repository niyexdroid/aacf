      ...
      <section className="bg-gray-50 py-16">
        <div className="container mx-auto px-4">
          <div className="text-center">
            <h2 className="mb-4 text-3xl font-bold text-gray-900">Visit Us</h2>
            <p className="mx-auto mb-8 max-w-2xl text-gray-600">
              We welcome visitors to our office. Come by during our office hours
              to learn more about our work and how you can get involved.
            </p>
            {/* You can add a Google Maps embed here if needed */}
            <div className="mx-auto flex h-64 max-w-4xl items-center justify-center rounded-lg bg-gray-300">
